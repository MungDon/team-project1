...
<SCRIPT>
	...
	function loadCancellationTable(url, startDate, endDate) {	//submit 되더라도 table페이지로 이동하지 않고 table이 해당페이지에 동기화되도록 함
...
<DIV style="font-size:25px; font-weight:bold"> 취소/반품/교환 내역 </DIV> <br />
...
<BUTTON id="buttonR" onclick=""> 취소/반품/교환 신청 내역 </BUTTON>
<BUTTON id="button"	onclick=""> 취소/반품/교환 처리 현황 </BUTTON>
	 
<jsp:include page="cancellationTable_request.jsp" />
<jsp:include page="cancellation.jsp" />